                          ...
                          CupertinoActionSheetAction(
                            onPressed: () async {
                              ...
                              if(pickedImage != null){
                                ...
                                RegisterImgReqDTO reqDTO = RegisterImgReqDTO(username: model.user.id, encodedImg: base64Image);
                                // 업로드된 이미지를 서버에 전송하는 로직
                                ref.watch(ProfileDetailProvider.notifier).notifyAddImage(reqDTO);
                              }
