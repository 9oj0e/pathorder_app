...
class PaymentTimeButtons extends StatefulWidget {
  @override
  _PaymentTimeButtons createState() => _PaymentTimeButtons();
}

class _PaymentTimeButtons extends State<PaymentTimeButtons> {
