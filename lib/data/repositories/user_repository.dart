...
class UserRepository {
  ...
  // 사진 등록
  Future<ResponseDTO> fetchImage(int userId,
      RegisterImgReqDTO registerImgReqDTO, String accessToken) async {
    final response = await dio.post("/api/users/${userId}",
        options: Options(headers: {"Authorization": "${accessToken}"}),
        data: registerImgReqDTO.toJson());
